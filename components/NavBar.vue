  ...
  <nav class="w-full p-6" id="back">
    <div class="flex items-center justify-between">
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-sm font-sans text-white font-bold">
          <li>
            <a href="#" class="pb-1">Explore</a>
          </li>
        ...
        <ul class="font-sans leading-relaxed">
          <li>
            <a
              href="#"
              @click="isOpen = false"
              class="my-4 capitalize text-2xl font-light"
              >Home</a
            >
          </li>
          <hr class="w-full" />
          <li>
            <a
              href="#"
              @click="isOpen = false"
              class="my-4 text-xl font-medium capitalize"
              >discover photos</a
            >
          </li>
          <li>
    ...
    <br />
    <div class="flex flex-wrap md:mx-2 overflow-hidden">
      <div
        class="
          my-2
          px-2
      ...
      <div class="md:my-2 md:px-2 w-full md:w-2/4 overflow-hidden md:py-20">
        <div class="text-3xl md:text-4xl font-semibold pb-3 mb-4 text-white">
